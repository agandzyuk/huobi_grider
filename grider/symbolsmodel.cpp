...
void SymbolsModel::initHUOBIRates()
{
    if(NULL == getSymbol(5000)) {
        instrumentCommit(Instrument("BTCCNY",5000),true);
        ini_.setValue(registryUsedGroup+"/BTCCNY",5000);
    }
    if(NULL == getSymbol(5001)) {
        instrumentCommit(Instrument("LTCCNY",5001),true);
        ini_.setValue(registryUsedGroup+"/LTCCNY",5001);
    }
    if(NULL == getSymbol(5002)) {
        instrumentCommit(Instrument("BTCUSD",5002),true);
        ini_.setValue(registryUsedGroup+"/BTCUSD",5002);
    }
    if(NULL == getSymbol(5003)) {
        instrumentCommit(Instrument("LTCUSD",5003),true);
        ini_.setValue(registryUsedGroup+"/LTCUSD",5003);
    }
}
